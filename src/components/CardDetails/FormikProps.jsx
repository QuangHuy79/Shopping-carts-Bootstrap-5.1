...
const AfterPayvalidationSchema = Yup.object({
  cardholderName: Yup.string()
    .matches(/^[A-Za-z\s'-]+$/, "Tên không hợp lệ")
    .required("Bắt buộc"),
...
export const AfterPayformikProps = {
  initialValues: AfterPayinitialValues,
  validationSchema: AfterPayvalidationSchema,
  onSubmit,
};
